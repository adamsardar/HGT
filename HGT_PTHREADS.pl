...
HGT_PTHREADS.pl --check n -itr 5000 -p 10 -i ./tree.nwk -o output --singlesim/--simulations
...
This script supercedes HGT-parallel.pl by making use of perls internal threading library, rather than rely on fork manager
...
die "Script still in active development and unsuitable for use\n";
...
B<threads> Used for multithreaded instances
